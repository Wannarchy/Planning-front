...
function Login() {
  ...
  return (
    <div style={{
      ...
      <div className="card border-0 shadow-sm" style={{ width: '380px', padding: '40px' }}>
        <h4 className="mb-1 fw-bold text-center">🎓 Ingetis Admin</h4>
        ...
        <button
          ...
          style={{ backgroundColor: '#5865F2', color: '#fff', border: 'none' }}
